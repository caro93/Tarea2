...
/*	Ejercicio 3
	Elaborado por Mendoza Saucedo Carolina
	*/
...
"}\n\0";
const GLchar* fragmentShaderSourceDos = "#version 330 core\n"
"out vec4 color;\n"
"void main()\n"
"{\n"
...
void GLApplication::initialize() {
	if (!windowManager
		|| !windowManager->initialize(800, 700, "Ejercicio3", false)) {
		this->destroy();
		exit(-1);
	}
	...
	glShaderSource(fragmentShader2, 1, &fragmentShaderSourceDos, NULL);
