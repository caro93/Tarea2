...
void GLApplication::initialize() {
	...
	VertexColorTexture vertices[36] = { 
		...
		{ glm::vec3(-0.5f, -0.5f, 0.5f), glm::vec3(1.0f, 1.0f, 1.0f), glm::vec2{ 0.0f, 0.0f } }, // 6
		{ glm::vec3(0.5f, -0.5f, 0.5f), glm::vec3(1.0f, 1.0f, 1.0f), glm::vec2{ 1.0f, 0.0f } }, // 5
		 
		{ glm::vec3(0.5f, 0.5f, 0.5f), glm::vec3(1.0f, 1.0f, 1.0f), glm::vec2{ 1.0f, 1.0f } }, // 4
		{ glm::vec3(-0.5f, 0.5f, 0.5f), glm::vec3(1.0f, 1.0f, 1.0f), glm::vec2{ 0.0f, 1.0f } }, //7
		{ glm::vec3(-0.5f, -0.5f, 0.5f), glm::vec3(1.0f, 1.0f, 1.0f), glm::vec2{ 0.0f, 0.0f } }, // 6
	...
	const char* filename = "Textures/circulos.png";
